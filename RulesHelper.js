...
//	mData.dangerLevel = pRule( pCalculator( (textA["terrorism"]+textA["biology"]+textA["physics"]+textA["chemistry"]+textA["biology"]+textA["technic"]+textA["emotions"]+textA["unknown_words"]+textA["words"]+textA["grammar_errors"]),textA["words"] ) , 0.3, 1.0, 'asc' );
	...
	if(pCalculator(textA["terrorism"],textA["words"])>0.02 || (pCalculator(c,textA["words"])>0.01 && ((textA["terrorism"],textA["words"])>0.001 || pCalculator(textA["grammars"],textA["words"])<0.05)) || pCalculator(textA["grammars"],textA["words"])<0.019){
		mData.dangerLevel = 3;
	}else if (pCalculator(textA["terrorism"],textA["words"])==0 && pCalculator(c,textA["words"])<0.05 && pCalculator(textA["grammars"],textA["words"])>0.12) {
		mData.dangerLevel = 1;
